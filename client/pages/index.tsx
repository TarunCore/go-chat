    ...
    try {
      const res = await fetch(`${API_URL}/ws/getRooms`, {
        ...
        headers: { 
          ...
          'Authorization': `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEiLCJ1c2VybmFtZSI6InRhcnVuIiwiaXNzIjoiMSIsImV4cCI6MTc0MzUwMTEzOX0.X0zY2019oyD90eDIBa7VBSbaJjdeUuS_ar7Ap1VXHHg`
        },
      })
